      ...
      'click-rail': function (t) {
        t.event.bind(t.scrollbarY, 'mousedown', function (t) {
          ...
          t.event.bind(t.scrollbarYRail, 'mousedown', function (e) {
            var i =
              e.pageY - window.pageYOffset - t.scrollbarYRail.getBoundingClientRect().top >
              t.scrollbarYTop
                ? 1
                : -1
          ...
          t.event.bind(t.scrollbarXRail, 'mousedown', function (e) {
            var i =
              e.pageX - window.pageXOffset - t.scrollbarXRail.getBoundingClientRect().left >
              t.scrollbarXLeft
                ? 1
                : -1
        ...
        t.event.bind(t.ownerDocument, 'keydown', function (r) {
          if (
            ...
            ;(t.settings.suppressScrollX && 0 !== s) ||
              ...
              ((i.scrollTop -= a), (i.scrollLeft += s), T(t), e(s, a) && r.preventDefault())
          }
        })
      },
      wheel: function (e) {
      ...
      touch: function (e) {
        function i(t, i) {
          ...
          if (o > n) {
            ...
            n > o &&
            ((t < 0 && l === e.contentWidth - e.containerWidth) || (t > 0 && 0 === l))
          )
            return !0
          return !0
        }
